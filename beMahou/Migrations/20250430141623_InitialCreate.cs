        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstrellasAcumuladas = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 0)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bar = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    Experiencia = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    Fecha = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    Estrellas = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 0),
                    FotoUrl = table.Column<string>(type: "TEXT", nullable: true),
                    Categoria = table.Column<int>(type: "INTEGER", nullable: false),
                    UsuarioId = table.Column<string>(type: "TEXT", nullable: true),
                    UsuarioMahouId = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicacionId1 = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
